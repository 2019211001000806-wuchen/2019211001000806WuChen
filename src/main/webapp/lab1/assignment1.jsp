...
<h3>  loog to print 2,4,6,8,10</h3>
...
<h3>  print all elements of array</h3>
...
<h3>  print "one","three","five","seven","nine"  of array</h3>
...
<h3> print person name :   and persons' dog name :</h3>
<ul>
...
<h3>print all words</h3>
<ul>
    <c:forTokens var="s"
                 items="one:two:three-four-five" delims=",">
        <li>${s}</li>
    </c:forTokens>
</ul>
</body>

										...
										<c:forEach	 var="c" items="${cart}">
											<tr>
												<td class="cart_product">
													<a href="">
														<img src="id=${c.product.productId}" alt="" style="height: 150px; width: 150px"></a>
												</td>
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="total_area">
											<ul>
												<li>Cart Sub Total <span><c:out value="${cal }"/></span><>
													<!--<li>Eco Tax <span>$2</span><>-->
												<li>Shipping Cost <span>Free</span><>
													<input type="hidden" name="orderTotal" value="${cal}"/>
												<li>Total <span><c:out value="${cal}"/></span><>
											</ul>

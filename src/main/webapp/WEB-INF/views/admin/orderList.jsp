			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.wuchen.model.Order o=(com.wuchen.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.wuchen.dao.UserDao userDao=new com.wuchen.dao.UserDao();
						...
						<%
							...
							String paymentType=com.wuchen.model.Payment.findByPaymentId(con,n);
							 %>
